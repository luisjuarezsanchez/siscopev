...
$cons = "TRUNCATE TABLE tmptimmaes;";

//Llamando al procedimiento que inserta los campos en tmptimmaes
//$consulta = "CALL sp_GeneraTmpTimMaes('$CveNomina')";
$consulta = "INSERT INTO tmptimmaes (CveEmp,Rfc,NomEmp,CveUniAds,CodCat,TipNom,CveIsse,Curp,TotPer,TotDed,TotNet,TotDes,Qna,Fecini,FecFin,NumChe,CveOrg,OriRec,CveBan,Cuenta,FecIniCon,Riesgo,SalDiaInt,TipCont,Subent,SubCau,AjusSub)
...
WHERE DetNomina.Clave=0202 AND empcont.TipoEmpleado=1  GROUP BY CvePersonal;";
...
$cons2 = "TRUNCATE TABLE tmptimdet;";
//Llamando al procedimiento que inserta los campos en tmptidet
//$consulta4 = "CALL sp_GeneraTmpTimDet('$CveNomina')";
$consulta4 = "INSERT INTO tmptimdet (CveEmp,CvePerDed,Monto,Descri,Cvesat,Qna,CveOrg) 
...
INNER JOIN EmpCont ON EmpCont.CvePersonal = DetNomina.CvePersonal
WHERE DetNomina.clave IN (5408,5540,5541,0202,5542,0325) AND empcont.TipoEmpleado=1 
ORDER BY DetNomina.CvePersonal;
";

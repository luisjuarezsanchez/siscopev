...
<body>
    ...
    <!--///////////////////Menú desplegable///////////////////////////-->
    <h1 id="tituloTabla">Elección de tipo de nómina</h1>
    <br>
    <style>
        #tituloTabla {
            color: #494e54;
        ...
        <tr>
            ...
            <td>
                <div class="card">
                    <div class="">
                        <div class=""><br>
                            <a href="nivelRango/pmenu.php"><img src="img/menu/NivelRango.png" width="180" height="180"></a>
                            <h5 class="card-title">Nomina Nivel-Rango</h5>
                            <p class="card-text">Generación de la nómina de Nivel-Rango</p>
                            <a href="nivelRango/pmenu.php" class="btn btn-primary">Ir</a><br>
                        </div>
                    </div>
                </div>
            </td>

...
,Contratos.Descripcion AS DescripcionCon,ComPerDed.Folio
...
<table border="1" align="center">
    ...
    <tr>
        <td colspan="3" class="informacion" valign="top" height="100" width="500">
            ...
            <strong>Puesto: &nbsp;</strong>' . $row['Descripcion'] . ' <br>
    ...
    WHERE CvePersonal ='$CveCapturada' AND CveNomina = '$CveNomina' AND PerDedApo.TipoPDA=0
    ...
    FROM DetNomina 
    INNER JOIN PerDedApo ON DetNomina.Clave = PerDedApo.Clave
    WHERE CvePersonal ='$CveCapturada' AND CveNomina = '$CveNomina' AND PerDedApo.TipoPDA=1
    GROUP BY DetNomina.Clave
    ORDER BY DetNomina.Clave ASC";

...
<body>
    ...
    <div id="main-container">
        ...
        <form class="form-login3"  action="update_empcont.php" method="POST">

            <p>Clave de contrato</p>
            <input class="controls" type="text" name="CvePersonal" placeholder="Ingresa la Clave de contrato" required>

            <p>Descripción</p>
            <input class="controls" type="text" name="CtaBanco" placeholder="Ingresa la descripción" required pattern="[A-Za-z]" title="Unicamente se aceptar caracteres alfabéticos">

            <p>Inicio de contrato</p>
            <input class="controls" type="date" name="CveContrato" placeholder="Ingresa la fecha de inicio" required>

            <p>Fin de contrato</p>
            <input class="controls" type="date" name="TipoEmpleado" placeholder="Ingresa el tipo de contrato" required>

            <p>Ingresa el año de contrato</p>
            <input class="controls" type="text" name="Inicio" placeholder="Ingresa el año del contrato" required>

            <p>Fecha de oficio</p>
            <input class="controls" type="date" name="Fin" placeholder="Ingresa la fecha de oficio" required>

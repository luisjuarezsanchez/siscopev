...
<body>
	...
	<br>
	<div>
    <h4 id="tituloTabla">Recuerda que la eliminacion de una nómina es un proceso irreversible <br>
    asegurate de seleccionar la nómina adecuada</h4>
    <br>
		<form class="form-login" action="delete_nominas.php" method="post" enctype="multipart/form-data">

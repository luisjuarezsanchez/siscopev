...
<body>
	...
	<div class="row row-cols-1 row-cols-md-3 g-4">
		...
		<div class="col" style="width: 18rem;">
			<div class="card text-center">
				<img src="img/expedientes/tlsr1.png" height="200" width="200">
				<div class="card-body">
					<h5 class="card-title">Actualización de tabla tlsr1</h5>
					<a id="ir" href="#" class="btn btn-primary">Ir</a>
				</div>
			</div>
		</div>
		...
		<div class="col" style="width: 18rem;">
			<div class="card text-center">
				<img src="img/expedientes/tlsr2.png" height="200" width="200">
				<div class="card-body">
					<h5 class="card-title">Actualización tabla tlsr2</h5>
		...
		<div class="col" style="width: 18rem;">
			<div class="card text-center">
				<img src="img/expedientes/contratos.png" height="200" width="200">
				<div class="card-body">
					<h5 class="card-title">Actualización contratos</h5>
					<a href="#" class="btn btn-primary">Ir</a>
				</div>
			</div>
		</div>
		...
		<div class="col" style="width: 18rem;">
			<div class="card text-center">
				<img src="img/expedientes/excentos.png" height="200" width="200">
				<div class="card-body">
					<h5 class="card-title">Actualización de excentos de aportacion</h5>
					<a href="#" class="btn btn-primary">Ir</a>
				</div>
			</div>
		</div>

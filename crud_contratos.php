...
<body>
    ...
    <div id="main-container">
        ...
        <a href="insertar_contratos.php">
                <p href="menu.php" style="text-align:right; margin-right: 20px;"><img src="img/expedientes/agregarcontrato.png" height="70" width="70" alt=""></p>
            </a>
        <form action="">
